...
const VerifiedBadge = () => (
  <svg viewBox="0 0 24 24" className={styles.verifiedIcon} aria-label="Verified">
    <path
      d="M9 12l2 2 4-4"
      stroke="currentColor"
      strokeWidth="2"
...
export default function Achievements() {
  ...
  useGSAP(() => {
    const header = sectionRef.current.querySelector(`.${styles.headerArea}`);
    const statItems = gsap.utils.toArray(`.${styles.statItem}`);
    const cards = gsap.utils.toArray(`.${styles.certCard}`);
    ...
    <section className={styles.achievements} ref={sectionRef} id="achievements">
      ...
      <div className={styles.headerArea}>
        ...
        <p className={styles.subtitle}>
          Industry-recognized credentials that validate expertise
        </p>
